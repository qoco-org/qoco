...
const QDLDL_int Ap[] = {0, 1, 2, 3, 4, 5, 6, 8, 10, 12, 14, 16, 20, 24, 28};
const QDLDL_int Ai[] = {0, 1,  2, 3,  4,  5,  0, 1,  1,  2,  0, 8,  1,  9,
                        2, 10, 3, 11, 12, 13, 4, 11, 12, 13, 5, 11, 12, 13};
...

{
  ...
  // now factor
  QDLDL_factor(An, Ap, Ai, Ax, Lp, Li, Lx, D, Dinv, Lnz, etree, bwork, iwork,
               fwork);
