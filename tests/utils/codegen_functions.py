...
def generate_test(problem_name, test_name):
    ...
    # Print header.
    f.write("// This file was autogenerated by the QCOS test suite on " + str(datetime.now().strftime("%m/%d/%Y %H:%M:%S")) + "\n\n")
    ...
    f.write("    QCOSSettings* settings = (QCOSSettings*)malloc(sizeof(QCOSSettings));\n")
...
def generate_data(P, c, A, b, G, h, l, ncones, q, problem_name, test_name):
