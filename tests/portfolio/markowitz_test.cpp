// This file was autogenerated by the QCOS test suite on 06/10/2024 21:49:00
...
TEST(portfolio_test, markowitz)
{
  ...
  if (markowitz_P_nnz > 0) {
    ...
    qcos_set_csc(P, markowitz_n, markowitz_n, markowitz_P_nnz, markowitz_P_x,
                 markowitz_P_p, markowitz_P_i);
  }
  else {
    P = nullptr;
  }
  if (markowitz_A_nnz > 0) {
    ...
    qcos_set_csc(A, markowitz_p, markowitz_n, markowitz_A_nnz, markowitz_A_x,
                 markowitz_A_p, markowitz_A_i);
  }
  else {
    A = nullptr;
  }
  if (markowitz_G_nnz > 0) {
    ...
    qcos_set_csc(G, markowitz_m, markowitz_n, markowitz_G_nnz, markowitz_G_x,
                 markowitz_G_p, markowitz_G_i);
  }
  else {
    G = nullptr;
  }
  ...
  QCOSInt exit = qcos_setup(solver, markowitz_n, markowitz_m, markowitz_p, P,
                            markowitz_c, A, markowitz_b, G, markowitz_h,
                            markowitz_l, markowitz_nsoc, markowitz_q, settings);
