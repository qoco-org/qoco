// This file was autogenerated by the QCOS test suite on 05/22/2024 23:43:04
...
TEST(ocp_test, pdg)
{
    ...
    QCOSInt exit = qcos_setup(solver, pdg_n, pdg_m, pdg_p, P, pdg_c, A, pdg_b, G, pdg_h, pdg_l, pdg_ncones, pdg_q, settings);
