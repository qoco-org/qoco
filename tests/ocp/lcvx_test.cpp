// This file was autogenerated by the QCOS test suite on 06/07/2024 13:13:13
...
TEST(ocp_test, lcvx)
{
    ...
    // Expect relative error of objective to be less that 0.5%
    expect_rel_error(solver->sol->obj, lcvx_objopt, 5e-3);
