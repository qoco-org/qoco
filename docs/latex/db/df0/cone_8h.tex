...
\begin{center}
\leavevmode
\includegraphics[width=202pt]{de/de5/cone_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Performs u = u + (1 + a) $\ast$ e where e is the cannonical vector for each cone LP Cone\+: e = ones(n), second-\/order cone\+: e = (1,0,0,...) and a is the minimum scalar value such that u + (1 + a) $\ast$ e is in cone C. \end{DoxyCompactList}\end{DoxyCompactItemize}
