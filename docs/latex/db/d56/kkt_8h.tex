...
\begin{DoxyCompactList}\small\item\em Constructs rhs for the affine scaling KKT system. Before calling this function, work-\/$>$kkt-\/$>$rhs must contain the residual of the KKT conditions as computed by \mbox{\hyperlink{kkt_8h_a1498e55f92c85bf1710e039f2a3c49f0}{compute\+\_\+kkt\+\_\+residual()}}. Also saves -\/rz into ubuff1. This is needed when constructing rhs for combined direction. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Constructs rhs for the combined direction KKT system. Before calling this function, work-\/$>$kkt-\/$>$rhs must contain the negative residual of the KKT conditions. The residual is computed by \mbox{\hyperlink{kkt_8h_a1498e55f92c85bf1710e039f2a3c49f0}{compute\+\_\+kkt\+\_\+residual()}} then negated by calling \mbox{\hyperlink{kkt_8h_a2aec873a47cf5ab8676af7a7579b69a0}{construct\+\_\+kkt\+\_\+aff\+\_\+rhs()}}. \end{DoxyCompactList}\item 
...
Constructs rhs for the affine scaling KKT system. Before calling this function, work-\/$>$kkt-\/$>$rhs must contain the residual of the KKT conditions as computed by \mbox{\hyperlink{kkt_8h_a1498e55f92c85bf1710e039f2a3c49f0}{compute\+\_\+kkt\+\_\+residual()}}. Also saves -\/rz into ubuff1. This is needed when constructing rhs for combined direction. 
...
Constructs rhs for the combined direction KKT system. Before calling this function, work-\/$>$kkt-\/$>$rhs must contain the negative residual of the KKT conditions. The residual is computed by \mbox{\hyperlink{kkt_8h_a1498e55f92c85bf1710e039f2a3c49f0}{compute\+\_\+kkt\+\_\+residual()}} then negated by calling \mbox{\hyperlink{kkt_8h_a2aec873a47cf5ab8676af7a7579b69a0}{construct\+\_\+kkt\+\_\+aff\+\_\+rhs()}}. 
