...
2. [Backend Architecture](#backend-architecture)
   ...
   - [CPU (Builtin) Backend](#cpu-builtin-backend)
   - [GPU (CUDA) Backend](#gpu-cuda-backend)
   - [Cone Implementation](#cone-implementation)
3. [Building](#building)
4. [Unit Tests](#unit-tests)
5. [CI Workflows](#ci-workflows)
