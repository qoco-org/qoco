...
#define SUITESPARSE_COMPILER_MINOR (__xlC__ - 256 * SUITESPARSE_COMPILER_MAJOR)
#define SUITESPARSE_COMPILER_SUB 0
...
#define SUITESPARSE_COMPILER_NAME                                              \
  "GNU gcc " SUITESPARSE_XSTR(__GNUC__) "." SUITESPARSE_XSTR(                  \
      __GNUC_MINOR__) "." SUITESPARSE_XSTR(__GNUC_PATCHLEVEL__)
...
#define SUITESPARSE_COMPILER_MINOR (_MSC_VER - 100 * SUITESPARSE_COMPILER_MAJOR)
#define SUITESPARSE_COMPILER_SUB 0
#define SUITESPARSE_COMPILER_NAME                                              \
...
int (*SuiteSparse_config_divcomplex_func_get(void))(double, double, double,
...
void SuiteSparse_config_divcomplex_func_set(
...
int SuiteSparse_config_divcomplex(double xr, double xi, double yr, double yi,
                                  double* zr, double* zi);
...
int SuiteSparse_divcomplex(double ar,
                           double ai, // real and imaginary parts of a
                           double br,
                           double bi, // real and imaginary parts of b
                           double* cr,
                           double* ci // real and imaginary parts of c
);
...
#define SUITESPARSE_DATE "Mar 22, 2024"
...
void SUITESPARSE_BLAS_DGEMV(
    // input:
    const char* trans, const SUITESPARSE_BLAS_INT* m,
    const SUITESPARSE_BLAS_INT* n, const double* alpha, const double* A,
    const SUITESPARSE_BLAS_INT* lda, const double* X,
    const SUITESPARSE_BLAS_INT* incx, const double* beta,
    // input/output:
    double* Y,
    // input:
    const SUITESPARSE_BLAS_INT* incy);

#define SUITESPARSE_BLAS_dgemv(trans, m, n, alpha, A, lda, X, incx, beta, Y,   \
                               incy, ok)                                       \
  {                                                                            \
    ...
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_DGEMV(trans, &M_blas_int, &N_blas_int, alpha, A,        \
                             &LDA_blas_int, X, &INCX_blas_int, beta, Y,        \
                             &INCY_blas_int);                                  \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_SGEMV(
    // input:
    const char* trans, const SUITESPARSE_BLAS_INT* m,
    const SUITESPARSE_BLAS_INT* n, const float* alpha, const float* A,
    const SUITESPARSE_BLAS_INT* lda, const float* X,
    const SUITESPARSE_BLAS_INT* incx, const float* beta,
    // input/output:
    float* Y,
    // input:
    const SUITESPARSE_BLAS_INT* incy);

#define SUITESPARSE_BLAS_sgemv(trans, m, n, alpha, A, lda, X, incx, beta, Y,   \
                               incy, ok)                                       \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
void SUITESPARSE_BLAS_ZGEMV(
    // input:
    const char* trans, const SUITESPARSE_BLAS_INT* m,
    const SUITESPARSE_BLAS_INT* n, const void* alpha, const void* A,
    const SUITESPARSE_BLAS_INT* lda, const void* X,
    const SUITESPARSE_BLAS_INT* incx, const void* beta,
    // input/output:
    void* Y,
    // input:
    const SUITESPARSE_BLAS_INT* incy);

#define SUITESPARSE_BLAS_zgemv(trans, m, n, alpha, A, lda, X, incx, beta, Y,   \
                               incy, ok)                                       \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
#define SUITESPARSE_BLAS_cgemv(trans, m, n, alpha, A, lda, X, incx, beta, Y,   \
                               incy, ok)                                       \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
void SUITESPARSE_BLAS_DTRSV(
    ...
    const SUITESPARSE_BLAS_INT* n, const double* A,
...
#define SUITESPARSE_BLAS_dtrsv(uplo, trans, diag, n, A, lda, X, incx, ok)      \
  {                                                                            \
    ...
    SUITESPARSE_TO_BLAS_INT(INCX_blas_int, incx, ok);                          \
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_DTRSV(uplo, trans, diag, &N_blas_int, A, &LDA_blas_int, \
                             X, &INCX_blas_int);                               \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_STRSV(
    // input:
    const char* uplo, const char* trans, const char* diag,
    const SUITESPARSE_BLAS_INT* n, const float* A,
    const SUITESPARSE_BLAS_INT* lda,
    // input/output:
    float* X,
    // input:
...
#define SUITESPARSE_BLAS_strsv(uplo, trans, diag, n, A, lda, X, incx, ok)      \
  {                                                                            \
    ...
    SUITESPARSE_TO_BLAS_INT(INCX_blas_int, incx, ok);                          \
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_STRSV(uplo, trans, diag, &N_blas_int, A, &LDA_blas_int, \
                             X, &INCX_blas_int);                               \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_ZTRSV(
    // input:
    const char* uplo, const char* trans, const char* diag,
    const SUITESPARSE_BLAS_INT* n, const void* A,
    const SUITESPARSE_BLAS_INT* lda,
    // input/output:
    void* X,
    // input:
...
#define SUITESPARSE_BLAS_ztrsv(uplo, trans, diag, n, A, lda, X, incx, ok)      \
  {                                                                            \
    ...
    SUITESPARSE_TO_BLAS_INT(INCX_blas_int, incx, ok);                          \
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_ZTRSV(uplo, trans, diag, &N_blas_int, A, &LDA_blas_int, \
                             X, &INCX_blas_int);                               \
    }                                                                          \
  }
...
#define SUITESPARSE_BLAS_ctrsv(uplo, trans, diag, n, A, lda, X, incx, ok)      \
  {                                                                            \
    ...
    SUITESPARSE_TO_BLAS_INT(INCX_blas_int, incx, ok);                          \
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_CTRSV(uplo, trans, diag, &N_blas_int, A, &LDA_blas_int, \
                             X, &INCX_blas_int);                               \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_DTRSM(
    ...
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const double* alpha, const double* A, const SUITESPARSE_BLAS_INT* lda,
    // input/output:
    double* B,
    // input:
    const SUITESPARSE_BLAS_INT* ldb);

#define SUITESPARSE_BLAS_dtrsm(side, uplo, transa, diag, m, n, alpha, A, lda,  \
                               B, ldb, ok)                                     \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    ...
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_DTRSM(side, uplo, transa, diag, &M_blas_int,            \
                             &N_blas_int, alpha, A, &LDA_blas_int, B,          \
                             &LDB_blas_int);                                   \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_STRSM(
    ...
    const char* side, const char* uplo, const char* transa, const char* diag,
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const float* alpha, const float* A, const SUITESPARSE_BLAS_INT* lda,
    // input/output:
    float* B,
    // input:
    const SUITESPARSE_BLAS_INT* ldb);

#define SUITESPARSE_BLAS_strsm(side, uplo, transa, diag, m, n, alpha, A, lda,  \
                               B, ldb, ok)                                     \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
void SUITESPARSE_BLAS_ZTRSM(
    ...
    const char* side, const char* uplo, const char* transa, const char* diag,
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const void* alpha, const void* A, const SUITESPARSE_BLAS_INT* lda,
    // input/output:
    void* B,
    // input:
    const SUITESPARSE_BLAS_INT* ldb);

#define SUITESPARSE_BLAS_ztrsm(side, uplo, transa, diag, m, n, alpha, A, lda,  \
                               B, ldb, ok)                                     \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
#define SUITESPARSE_BLAS_ctrsm(side, uplo, transa, diag, m, n, alpha, A, lda,  \
                               B, ldb, ok)                                     \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
void SUITESPARSE_BLAS_DGEMM(
    // input:
    const char* transa, const char* transb, const SUITESPARSE_BLAS_INT* m,
    const SUITESPARSE_BLAS_INT* n, const SUITESPARSE_BLAS_INT* k,
    const double* alpha, const double* A, const SUITESPARSE_BLAS_INT* lda,
    const double* B, const SUITESPARSE_BLAS_INT* ldb, const double* beta,
    // input/output:
    double* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc);

#define SUITESPARSE_BLAS_dgemm(transa, transb, m, n, k, alpha, A, lda, B, ldb, \
                               beta, C, ldc, ok)                               \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    ...
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_DGEMM(transa, transb, &M_blas_int, &N_blas_int,         \
                             &K_blas_int, alpha, A, &LDA_blas_int, B,          \
                             &LDB_blas_int, beta, C, &LDC_blas_int);           \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_SGEMM(
    ...
    const SUITESPARSE_BLAS_INT* n, const SUITESPARSE_BLAS_INT* k,
    const float* alpha, const float* A, const SUITESPARSE_BLAS_INT* lda,
    const float* B, const SUITESPARSE_BLAS_INT* ldb, const float* beta,
    // input/output:
    float* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc);

#define SUITESPARSE_BLAS_sgemm(transa, transb, m, n, k, alpha, A, lda, B, ldb, \
                               beta, C, ldc, ok)                               \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
void SUITESPARSE_BLAS_ZGEMM(
    ...
    const SUITESPARSE_BLAS_INT* n, const SUITESPARSE_BLAS_INT* k,
    const void* alpha, const void* A, const SUITESPARSE_BLAS_INT* lda,
    const void* B, const SUITESPARSE_BLAS_INT* ldb, const void* beta,
    // input/output:
    void* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc);

#define SUITESPARSE_BLAS_zgemm(transa, transb, m, n, k, alpha, A, lda, B, ldb, \
                               beta, C, ldc, ok)                               \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
#define SUITESPARSE_BLAS_cgemm(transa, transb, m, n, k, alpha, A, lda, B, ldb, \
                               beta, C, ldc, ok)                               \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
void SUITESPARSE_BLAS_DSYRK(
    // input:
    const char* uplo, const char* trans, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const double* alpha, const double* A,
    const SUITESPARSE_BLAS_INT* lda, const double* beta,
    // input/output:
    double* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc);

#define SUITESPARSE_BLAS_dsyrk(uplo, trans, n, k, alpha, A, lda, beta, C, ldc, \
                               ok)                                             \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    SUITESPARSE_TO_BLAS_INT(LDC_blas_int, ldc, ok);                            \
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_DSYRK(uplo, trans, &N_blas_int, &K_blas_int, alpha, A,  \
                             &LDA_blas_int, beta, C, &LDC_blas_int);           \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_SSYRK(
    // input:
    const char* uplo, const char* trans, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const float* alpha, const float* A,
    const SUITESPARSE_BLAS_INT* lda, const float* beta,
    // input/output:
    float* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc);

#define SUITESPARSE_BLAS_ssyrk(uplo, trans, n, k, alpha, A, lda, beta, C, ldc, \
                               ok)                                             \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    SUITESPARSE_TO_BLAS_INT(LDC_blas_int, ldc, ok);                            \
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_SSYRK(uplo, trans, &N_blas_int, &K_blas_int, alpha, A,  \
                             &LDA_blas_int, beta, C, &LDC_blas_int);           \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_ZHERK(
    // input:
    const char* uplo, const char* trans, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const void* alpha, const void* A,
    const SUITESPARSE_BLAS_INT* lda, const void* beta,
    // input/output:
    void* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc);

#define SUITESPARSE_BLAS_zherk(uplo, trans, n, k, alpha, A, lda, beta, C, ldc, \
                               ok)                                             \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    SUITESPARSE_TO_BLAS_INT(LDC_blas_int, ldc, ok);                            \
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_ZHERK(uplo, trans, &N_blas_int, &K_blas_int, alpha, A,  \
                             &LDA_blas_int, beta, C, &LDC_blas_int);           \
    }                                                                          \
  }
...
#define SUITESPARSE_BLAS_cherk(uplo, trans, n, k, alpha, A, lda, beta, C, ldc, \
                               ok)                                             \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    SUITESPARSE_TO_BLAS_INT(LDC_blas_int, ldc, ok);                            \
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_CHERK(uplo, trans, &N_blas_int, &K_blas_int, alpha, A,  \
                             &LDA_blas_int, beta, C, &LDC_blas_int);           \
    }                                                                          \
  }
...
void SUITESPARSE_LAPACK_DPOTRF(
    // input:
    const char* uplo, const SUITESPARSE_BLAS_INT* n,
    // input/output:
    double* A,
    // input:
    const SUITESPARSE_BLAS_INT* lda,
...
void SUITESPARSE_BLAS_DSCAL(
    // input:
    const SUITESPARSE_BLAS_INT* n, const double* alpha,
    // input/output:
    double* Y,
    // input:
    const SUITESPARSE_BLAS_INT* incy);
...
void SUITESPARSE_BLAS_SSCAL(
    // input:
    const SUITESPARSE_BLAS_INT* n, const float* alpha,
    // input/output:
    float* Y,
    // input:
    const SUITESPARSE_BLAS_INT* incy);
...
void SUITESPARSE_BLAS_ZSCAL(
    // input:
    const SUITESPARSE_BLAS_INT* n, const void* alpha,
    // input/output:
    void* Y,
    // input:
    const SUITESPARSE_BLAS_INT* incy);
...
void SUITESPARSE_BLAS_DGER(
    // input:
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const double* alpha, const double* X, const SUITESPARSE_BLAS_INT* incx,
    const double* Y, const SUITESPARSE_BLAS_INT* incy,
    // input/output:
    double* A,
    // input:
    const SUITESPARSE_BLAS_INT* lda);
  ...
  {                                                                            \
    ...
    if (ok) {                                                                  \
      SUITESPARSE_BLAS_DGER(&M_blas_int, &N_blas_int, alpha, X,                \
                            &INCX_blas_int, Y, &INCY_blas_int, A,              \
                            &LDA_blas_int);                                    \
    }                                                                          \
  }
...
void SUITESPARSE_BLAS_SGER(
    // input:
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const float* alpha, const float* X, const SUITESPARSE_BLAS_INT* incx,
    const float* Y, const SUITESPARSE_BLAS_INT* incy,
    // input/output:
    float* A,
    // input:
    const SUITESPARSE_BLAS_INT* lda);
...
void SUITESPARSE_BLAS_ZGERU(
    // input:
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const void* alpha, const void* X, const SUITESPARSE_BLAS_INT* incx,
    const void* Y, const SUITESPARSE_BLAS_INT* incy,
    // input/output:
    void* A,
    // input:
    const SUITESPARSE_BLAS_INT* lda);
...
void SUITESPARSE_LAPACK_DLARFT(
    // input:
    const char* direct, const char* storev, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const double* V,
    const SUITESPARSE_BLAS_INT* ldv, const double* Tau,
    // output:
    double* T,
    // input:
    const SUITESPARSE_BLAS_INT* ldt);

#define SUITESPARSE_LAPACK_dlarft(direct, storev, n, k, V, ldv, Tau, T, ldt,   \
                                  ok)                                          \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    if (ok) {                                                                  \
      SUITESPARSE_LAPACK_DLARFT(direct, storev, &N_blas_int, &K_blas_int, V,   \
                                &LDV_blas_int, Tau, T, &LDT_blas_int);         \
    }                                                                          \
  }
...
void SUITESPARSE_LAPACK_SLARFT(
    // input:
    const char* direct, const char* storev, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const float* V,
    const SUITESPARSE_BLAS_INT* ldv, const float* Tau,
    // output:
    float* T,
    // input:
    const SUITESPARSE_BLAS_INT* ldt);

#define SUITESPARSE_LAPACK_slarft(direct, storev, n, k, V, ldv, Tau, T, ldt,   \
                                  ok)                                          \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    SUITESPARSE_TO_BLAS_INT(LDT_blas_int, ldt, ok);                            \
    if (ok) {                                                                  \
      SUITESPARSE_LAPACK_SLARFT(direct, storev, &N_blas_int, &K_blas_int, V,   \
                                &LDV_blas_int, Tau, T, &LDT_blas_int);         \
    }                                                                          \
  }
...
void SUITESPARSE_LAPACK_ZLARFT(
    // input:
    const char* direct, const char* storev, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const void* V,
    const SUITESPARSE_BLAS_INT* ldv, const void* Tau,
    // output:
    void* T,
    // input:
    const SUITESPARSE_BLAS_INT* ldt);

#define SUITESPARSE_LAPACK_zlarft(direct, storev, n, k, V, ldv, Tau, T, ldt,   \
                                  ok)                                          \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    SUITESPARSE_TO_BLAS_INT(LDT_blas_int, ldt, ok);                            \
    if (ok) {                                                                  \
      SUITESPARSE_LAPACK_ZLARFT(direct, storev, &N_blas_int, &K_blas_int, V,   \
                                &LDV_blas_int, Tau, T, &LDT_blas_int);         \
    }                                                                          \
  }
...
#define SUITESPARSE_LAPACK_clarft(direct, storev, n, k, V, ldv, Tau, T, ldt,   \
                                  ok)                                          \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    SUITESPARSE_TO_BLAS_INT(LDT_blas_int, ldt, ok);                            \
    if (ok) {                                                                  \
      SUITESPARSE_LAPACK_CLARFT(direct, storev, &N_blas_int, &K_blas_int, V,   \
                                &LDV_blas_int, Tau, T, &LDT_blas_int);         \
    }                                                                          \
  }
...
void SUITESPARSE_LAPACK_DLARFB(
    ...
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const double* V,
    const SUITESPARSE_BLAS_INT* ldv, const double* T,
    const SUITESPARSE_BLAS_INT* ldt,
    // input/output:
    double* C,
    // input:
...
#define SUITESPARSE_LAPACK_dlarfb(side, trans, direct, storev, m, n, k, V,     \
                                  ldv, T, ldt, C, ldc, Work, ldwork, ok)       \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
    SUITESPARSE_TO_BLAS_INT(K_blas_int, k, ok);                                \
    ...
    if (ok) {                                                                  \
      SUITESPARSE_LAPACK_DLARFB(side, trans, direct, storev, &M_blas_int,      \
                                &N_blas_int, &K_blas_int, V, &LDV_blas_int, T, \
                                &LDT_blas_int, C, &LDC_blas_int, Work,         \
                                &LDWORK_blas_int);                             \
    }                                                                          \
  }
...
void SUITESPARSE_LAPACK_SLARFB(
    ...
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const float* V,
    const SUITESPARSE_BLAS_INT* ldv, const float* T,
    const SUITESPARSE_BLAS_INT* ldt,
    // input/output:
    float* C,
    // input:
...
#define SUITESPARSE_LAPACK_slarfb(side, trans, direct, storev, m, n, k, V,     \
                                  ldv, T, ldt, C, ldc, Work, ldwork, ok)       \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
void SUITESPARSE_LAPACK_ZLARFB(
    ...
    const SUITESPARSE_BLAS_INT* m, const SUITESPARSE_BLAS_INT* n,
    const SUITESPARSE_BLAS_INT* k, const void* V,
    const SUITESPARSE_BLAS_INT* ldv, const void* T,
    const SUITESPARSE_BLAS_INT* ldt,
    // input/output:
    void* C,
    // input:
...
#define SUITESPARSE_LAPACK_zlarfb(side, trans, direct, storev, m, n, k, V,     \
                                  ldv, T, ldt, C, ldc, Work, ldwork, ok)       \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
#define SUITESPARSE_LAPACK_clarfb(side, trans, direct, storev, m, n, k, V,     \
                                  ldv, T, ldt, C, ldc, Work, ldwork, ok)       \
  {                                                                            \
    SUITESPARSE_TO_BLAS_INT(M_blas_int, m, ok);                                \
    SUITESPARSE_TO_BLAS_INT(N_blas_int, n, ok);                                \
...
double SUITESPARSE_BLAS_DNRM2(
    // input:
    const SUITESPARSE_BLAS_INT* n, const double* X,
    const SUITESPARSE_BLAS_INT* incx);
...
float SUITESPARSE_BLAS_SNRM2(
    // input:
    const SUITESPARSE_BLAS_INT* n, const float* X,
    const SUITESPARSE_BLAS_INT* incx);
...
double SUITESPARSE_BLAS_DZNRM2(
    // input:
    const SUITESPARSE_BLAS_INT* n, const void* X,
    const SUITESPARSE_BLAS_INT* incx);
...
#define SUITESPARSE_LAPACK_slarfg(n, alpha, X, incx, tau, ok)                  \
  {                                                                            \
    ...
    SUITESPARSE_TO_BLAS_INT(INCX_blas_int, incx, ok);                          \
    if (ok) {                                                                  \
      SUITESPARSE_LAPACK_SLARFG(&N_blas_int, alpha, X, &INCX_blas_int, tau);   \
    }                                                                          \
  }
...
#define SUITESPARSE_LAPACK_clarfg(n, alpha, X, incx, tau, ok)                  \
  {                                                                            \
    ...
    SUITESPARSE_TO_BLAS_INT(INCX_blas_int, incx, ok);                          \
    if (ok) {                                                                  \
      SUITESPARSE_LAPACK_CLARFG(&N_blas_int, alpha, X, &INCX_blas_int, tau);   \
    }                                                                          \
  }
...
void SUITESPARSE_LAPACK_DLARF(
    // input:
    const char* side, const SUITESPARSE_BLAS_INT* m,
    const SUITESPARSE_BLAS_INT* n, const double* V,
    const SUITESPARSE_BLAS_INT* incv, const double* tau,
    // input/output:
    double* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc,
...
void SUITESPARSE_LAPACK_SLARF(
    // input:
    const char* side, const SUITESPARSE_BLAS_INT* m,
    const SUITESPARSE_BLAS_INT* n, const float* V,
    const SUITESPARSE_BLAS_INT* incv, const float* tau,
    // input/output:
    float* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc,
...
void SUITESPARSE_LAPACK_ZLARF(
    // input:
    const char* side, const SUITESPARSE_BLAS_INT* m,
    const SUITESPARSE_BLAS_INT* n, const void* V,
    const SUITESPARSE_BLAS_INT* incv, const void* tau,
    // input/output:
    void* C,
    // input:
    const SUITESPARSE_BLAS_INT* ldc,
