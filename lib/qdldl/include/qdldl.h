 ...
 *
 * QDLDL is part of the OSQP project, and is available at
 * https://github.com/osqp/qdldl.
 *
 * Copyright 2018, Paul Goulart, Bartolomeo Stellato, Goran Banjac, Ian
 * McInerney, The OSQP developers
 *
...
/* MODIFIED BY GOVIND CHARI. DYNAMIC REGULARIZATION ADDED. */
 ...
 *
 */
QDLDL_API QDLDL_int QDLDL_etree(const QDLDL_int n, const QDLDL_int* Ap,
                                const QDLDL_int* Ai, QDLDL_int* work,
 ...
 *
 */
QDLDL_API QDLDL_int QDLDL_factor(const QDLDL_int n, const QDLDL_int* Ap,
                                 const QDLDL_int* Ai, const QDLDL_float* Ax,
 ...
 *
 */
QDLDL_API void QDLDL_solve(const QDLDL_int n, const QDLDL_int* Lp,
                           const QDLDL_int* Li, const QDLDL_float* Lx,
 ...
 *
 */
QDLDL_API void QDLDL_Lsolve(const QDLDL_int n, const QDLDL_int* Lp,
                            const QDLDL_int* Li, const QDLDL_float* Lx,
                            QDLDL_float* x);
 ...
 *
 */
QDLDL_API void QDLDL_Ltsolve(const QDLDL_int n, const QDLDL_int* Lp,
                             const QDLDL_int* Li, const QDLDL_float* Lx,
                             QDLDL_float* x);
